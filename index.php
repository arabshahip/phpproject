...
<title>Parisa Arabshahi by Bryant Smith</title>
</head>
...
<div id="navBottom"></div>
    ...
    <!--Start Content Box -->
      ...
      <div class="contentTop"></div>
      <div class="contentMain"> 
            <h1><a href ="http://localhost:8080/parisa/index.php">صفحه ورود</a></h1>
			<h1><a href ="http://localhost:8080/parisa/login.php">فرم ورود</a></h1>
               
				<form action = "destitation.php" method="POST">
